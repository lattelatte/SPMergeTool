...
namespace SPMerge.Util
{
    ...
    public class UpgradeObjects
    {
        ...
        public UpgradeObjects()
        {
            ...
            List.Add(new UpgradeObject() { TableName = "Benchmark", UpdateColumns = new string[] { } });
            ...
            List.Add(new UpgradeObject() { TableName = "Calendar", UpdateColumns = new string[] { "Id" } });
            List.Add(new UpgradeObject() { TableName = "CalendarItem", UpdateColumns = new string[] { "Id", "CalendarId" } });
            List.Add(new UpgradeObject() { TableName = "CarbonFactor", UpdateColumns = new string[] { "Id" } });
            ...
            List.Add(new UpgradeObject() { TableName = "Customer", UpdateColumns = new string[] { "HierarchyId" } });
            ...
            List.Add(new UpgradeObject() { TableName = "Labeling", UpdateColumns = new string[] { "Id" } });
            ...
            List.Add(new UpgradeObject() { TableName = "Role", UpdateColumns = new string[] { "Id" } });
            ...
            List.Add(new UpgradeObject() { TableName = "TouTariff", UpdateColumns = new string[] { "Id" } });
            List.Add(new UpgradeObject() { TableName = "TouTariffItem", UpdateColumns = new string[] { "Id", "TouTariffId" } });
            List.Add(new UpgradeObject() { TableName = "User", UpdateColumns = new string[] { "Id" } });
